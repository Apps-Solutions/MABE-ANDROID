 ...
 */
public class FragmentShelfReviewSelfservice extends Fragment implements View.OnClickListener,
    ...
    public void recoverInfoFromUI(){
        ...
        for(Map<String,String> itemProduct : prod_added_list) {
            ...
            try {
                ...
                Log.d(TAG,"OBJ: "+jsonObj.toString());
