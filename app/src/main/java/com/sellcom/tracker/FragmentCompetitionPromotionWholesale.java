 ...
 */
public class FragmentCompetitionPromotionWholesale extends Fragment implements UIResponseListenerInterface,View.OnClickListener,FragmentPartialPayDialog.setSetImgPhoto, ConfirmationDialogListener {

    final static public String TAG = "competition_promotion_wholesale";
